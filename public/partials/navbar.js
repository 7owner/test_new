export const NAVBAR_HTML = `
  <!-- HEADER avec barre utilisateur -->
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <div class="offcanvas-body">
      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
        <li class="nav-item"><a class="nav-link active" href="/dashboard.html"><i class="bi bi-house-door-fill me-2"></i>Dashboard</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="/factures.html"><i class="bi bi-person-plus-fill me-2"></i>Nouveau Client</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="/Catalogue_materiel.html"><i class="bi bi-receipt-cutoff me-2"></i>Catalogue_materiel</a></li>
...
export function loadNavbarIntoPlaceholder(placeholderId = 'navbar-placeholder') {
